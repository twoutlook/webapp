                ...
                zlib.gunzip(body, function (err, dezipped) {
                    ...
                    try {
                        ...
                        var onDocNumComplete = function(error) {
                          if (error) {
                            console.log('buslistv9-docnum:'+docNum+', onSetComplete Synchronization failed'+error);
                          } else {
                            console.log('buslistv9-docnum:'+docNum+', onSetComplete Synchronization succeeded');
                        ...
                        var onSetComplete = function(error) {
                          if (error) {
                            console.log('buslistv9-doc'+docNum+"/doc"+', onSetComplete Synchronization failed'+error);
                          } else {
                            console.log('buslistv9-doc'+docNum+"/doc"+', onSetComplete Synchronization succeeded');

                            fbRef.child('buslistv9-docnum').set({num:docNum}, onDocNumComplete );
                          }
                        };

                        // 2/4 18:24
                        fbRef.child('buslistv9-doc'+docNum+"/doc").set(busList3,onSetComplete ); // 只要有出現的公車就加進來
